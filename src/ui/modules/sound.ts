 ...
 */
export function setupMusicWindow(): void {
  ...
  volumeSlider.oninput = (e: Event) => {
    musicSystem.setVolume(parseFloat((e.target as HTMLInputElement).value));
  };
 ...
 */
function createPlaylistModal(): void {
 ...
 */
function setAllTracks(selected: boolean): void {
  if (selected) {
 ...
 */
function setCategoryTracks(category: string): void {
