...
import { ZODIAC_IDS, ZODIAC_SIGNS } from '../data/zodiac';
import { Logger } from '../utils/logger';

export function createZodiacSigns(scene: THREE.Object3D, textureLoader: THREE.TextureLoader) {
...
export async function alignZodiacSigns(zodiacSignsGroup: THREE.Group) {
