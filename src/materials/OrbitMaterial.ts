 ...
 */
function createDashTexture(): THREE.DataTexture {
  const size = 64;
 ...
 */
export function createProgressAttribute(numPoints: number, currentIndex: number = 0): Float32Array {
 ...
 * @param {number} currentIndex - Index of the current position (0-based)
 */
export function updateProgressAttribute(
